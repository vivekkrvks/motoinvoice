...
const listData1 = [
	...
	{ text: "Add Invoice", link: "/AddInvoice", icon: <CategoryIcon color="success" /> },
	{ text: "Add Category", link: "/AddCategory", icon: <CategoryIcon color="success" /> },
	{ text: "AddBikeModels", link: "/AddBikeModels", icon: <ApprovalIcon color="success" />,Supervisor:true },
	{ text: "Add SubCategory", link: "/AddSubCategory", icon: <ApprovalIcon color="success" />,Supervisor:true },
  { text: "Add Company Profile", link: "/AddCompanyProfile", icon: <ControlPointDuplicateIcon color="success" />,Supervisor:true },
